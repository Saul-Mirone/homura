...
const ToolkitItem: React.FC<ToolKitProps & { target: Mode; icon: JSX.Element }> = ({
    mode,
    onSwitchMode,
    target,
    icon,
...
export const Toolkit: React.FC<ToolKitProps> = ({ mode, onSwitchMode }) => (
    <div className="sub-side-bar__toolkit">
        <div>
            <ToolkitItem mode={mode} onSwitchMode={onSwitchMode} target={Mode.Starred} icon={<StarFilledIcon />} />
            <ToolkitItem mode={mode} onSwitchMode={onSwitchMode} target={Mode.Unread} icon={<MailFilledIcon />} />
            <ToolkitItem mode={mode} onSwitchMode={onSwitchMode} target={Mode.All} icon={<ViewListFilledIcon />} />
        </div>
    </div>
);
